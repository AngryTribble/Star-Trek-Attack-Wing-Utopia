...
/*  
/*  experimental fix, remove factionPenalty function and instead check for 'prime factions' in $factions.hasFaction - this eliminates code like the following:
/*  $factions.hasFaction( ship, "vulcan", ship, fleet ) ? 0 : 1 && $factions.hasFaction( ship, "bajoran", ship, fleet ) ? 0 : 1

*  as a prime faction can easily be checked without checking each and every sub faction.
*  note: all cards that already have an overridden factionPenalty function as a cardRules entry will continue to work as they did before.
*/
//George Sanders
// "captain:Cap016":{
// 	factionPenalty: function(upgrade, ship, fleet) {
