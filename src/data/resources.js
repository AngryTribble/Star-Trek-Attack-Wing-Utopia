module.exports = [{
	...
	set: ["CollectiveOP3"],
	name: "Officer Cards",
	text: "1) Players receive a set of 4 Officer Cards and may choose to use any number of them during the Tournament. Each Officer Card costs 3 SP to deploy to your fleet.\r\n\r\n2) Officer Cards are assigned to one or more of your [crew_text] Upgrades. When assigning these cards, be sure to stack the Officer Card beneath the [crew_text] Upgrade so that the lower half of the Officer Card is visible. You may assign up to 2 Officer Cards to any of your [crew_text] Upgrades.\r\n\r\n3) Officer Cards add bonus text-based abilities and Upgrade Slots to the assigned [crew_text] Upgrade and/or his ship. Players may use the bonus text-based abilities in addition to their [crew_text] Upgrade's normal text-based ability (if applicable) during the Battle.\r\n\r\n4) The First Officer Card has an [talent_text] icon at the bottom of the card. This allows the First Officer's ship to field 1 [talent_text] Upgrade as though the First Officer were a Captain. This [talent_text] Upgrade is in addition to any [talent_text] Upgrade(s) that your ship's Captain can field.\r\n\r\n5) If a [crew_text] Upgrade that has one or more Officer Cards assigned to it is ever disabled, its assigned Officer Card(s) are considered disabled as well. If a [crew_text] Upgrade that has one or more Officer Cards assigned to it is ever discarded, its assigned Officer Card(s) are considered discarded as well. NOTE: If the First Officer is ever discarded, his [talent_text] Upgrade is discarded as well.",
	cost: 0,
	opBanned: true,
	showShipResourceSlot: false
}, {
	...
	cost: 5,
	opBanned: true,
	text: "During the Activation Phase, any ship in your fleet may:\n\n1) Disable one of its [tech_text] Upgrades to use an Action from its Action Bar as a free Action.\n\nOR\n\n2) Discard one of its already disabled [tech_text] Upgrades to use an Action from its Action Bar as a free Action.\n\nA ship cannot perform any other free Actions on the round that it uses either of these abilities."
}, {
	type: "resource",
	id: "R024",
	gameId: 1,
	...
	cost: 0,
	opBanned: true,
	text: "This card explains the rules for the Main Power Grid Resource Card and serves as a reference to remind players of its effect. This resource costs 3 SP plus 2 SP for each Hull Value greater than 3. \n\nOnce per round, one of your ships my use on the the following abilities:\r\n\r\n1)  When attacking with your Primary Weapon, during the Roll Attack Dice step, suffer 1 damage to your Hull and disable all your remaining Shields to roll +2 attack dice that round.\r\n\r\nOR\r\n\r\n2)  When defending, during the Compare Results step cancel up to 2 of the attacking ship's dice and place an Auxiliary Power Token beside your ship. Your ship cannot attack during the round you use this ability.",
	showShipResourceSlot: false
}, {
	type: "resource",
	id: "R025",
	...
	cost: 5,
	opBanned: true,
	text: "At the start of the battle, place 2 [evade] Tokens, 2 [scan] Tokens and 2 [battlestations] Tokens on top of this card. \n\nEach round, during the Activation Phase, one ship in your fleet may choose on of the Tokens from on top of this card and place it beside its base. Treat this as if that ship performed a free Action of the appropriate type.\r\n\r\nIf the ship performing this Action does not have the Action listed on its Action Bar, it may still perform the Action, but it is considered a Standard Action instead of a free Action. in Addition, place an Auxiliary Power Token beside that ship."
}, {
	type: "resource",
	id: "R026",
	gameId: 1,
	...
	text: "At the start of the game place 5 Evade Tokens on this card. \n\nDuring the Activation Phase, if an opposing ship that is within Range 1-2 of one of your ships performs a [scan], [battlestations], or [cloak] Action from its Action Bar, you may choose to immediately remove 1 [evade] Token from this card and place it beside your ship, even if there is already one there. \n\nYou can only use this ability once per round.\n\nRemove this card from the game when there are no [evade] Tokens left on this card.",
	cost: 5,
	opBanned: true,
	showShipResourceSlot: false
}, {
	...
	set: ["72284r"],
	name: "Senior Staff",
	text: "Each ship in your fleet may field 1 additional [talent_text] Upgrade for every [crew_text] Upgrade assigned to it.\n\nEach [talent_text] Upgrade is placed next to the [crew_text] Upgrade that fielded it. \n\nIf the [crew_text] Upgrade is ever discarded, you must also discard the [talent_text] Upgrade that was fielded by that [crew_text] Upgrade.\n\n The cost of this resource is 1 SP for each additional [talent_text] Upgrade you assign to your fleet.",
	cost: 0,
	opBanned: true,
	showShipResourceSlot: false
}, {
	...
	set: ["72321r"],
	name: "Sick Bay",
	text: "This card can only be assigned to one of your ships that has a Hull Value of 4 or more.\n\nWhenever this ship's Captain, Admiral, or [crew_text] would be disabled, you may place 2 [time] Tokens on that card instead.\n\n-OR-\n\nWhenever this ship's Captain, Admiral, or [crew_text] would be discarded, you may discard this card instead.",
	cost: 6,
	opBanned: true,
	showShipResourceSlot: false
}];
