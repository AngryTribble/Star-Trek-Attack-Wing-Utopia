module.exports = [{
	...
	set: ["72284r"],
	name: "Senior Staff",
	text: "Each ship in your fleet may field 1 additional [talent] Upgrade for every [crew] Upgrade assigned to it.\n\nEach [talent] Upgrade is placed next to the [crew] Upgrade that fielded it. \n\nIf the [crew] Upgrade is ever discarded, you must also discard the [talent] Upgrade that was fielded by that [crew] Upgrade.\n\n The cost of this resource is 1 SP for each additional [talent] Upgrade you assign to your fleet.",
	cost: 0,
	opBanned: true,
	showShipResourceSlot: false
}, {
	...
	set: ["72321r"],
	name: "Sick Bay",
	text: "This card can only be assigned to one of your ships that has a Hull Value of 4 or more.\n\nWhenever this ship's Captain, Admiral, or [crew] would be disabled, you may place 2 [time] Tokens on that card instead.\n\n-OR-\n\nWhenever this ship's Captain, Admiral, or [crew] would be discarded, you may discard this card instead.",
	cost: 6,
	opBanned: true,
	showShipResourceSlot: false
}];
