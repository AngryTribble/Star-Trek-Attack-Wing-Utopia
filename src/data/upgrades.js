module.exports = [
	{
		...
		cost: 1,
		text: "This card can only be equipped to a Unique ship whose name, ignoring registry number, listed after the 'U.S.S.' is the same as the ship class. \n----------------------------------------\n Add 1 [tech], [weapon], or [crew] to this ship's Upgrade Bar. \n\n <b>WHEN DEFENDING: MODIFY DEFENSE DICE STEP:</b> \n You may re-roll 1 [blank] or [battlestations] .",
		OnePerShip: true,
		factions: [
			"federation"
		]
